---
name: create-multiple-scene-video
description: Create a multiple-scene video from a written requirement. Use when the user wants a generated video with multiple scenes, image and audio support, educational or presentation-style structure, or HTML-style animation and visual storytelling.
---

# AI Builder - Create Multiple Scene Video

This skill creates a multiple-scene video from a requirement. The request can describe multi-scene output, image and audio support, educational or presentation-style structure, and HTML or animation-oriented visual goals.

## When to Use This Skill

- The user asks to create a CPU video.
- The user asks to create a multiple-scene video.
...
- **Backend Developer**: Build the JSON payload correctly and run `core/bin/api-invoke create_multiple_scene_video`.
...
Run `core/bin/api-invoke create_multiple_scene_video '<json-payload>'` from the repo root.
