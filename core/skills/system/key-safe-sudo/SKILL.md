...
For env actions — `enable`, `disable`, `get_key_names`, `get_key_value`, `put_key_values` — follow [references/keys-safe-guard.md](references/keys-safe-guard.md). Quick summary:
